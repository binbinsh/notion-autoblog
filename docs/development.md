...
- restore：`gridplanet-<branch>-media-v2-<run_id>-<run_attempt>`
- restore prefix：`gridplanet-<branch>-media-v2-`
- save：当前 run 的完整 key
...
- `__pycache__/`
- `*.egg-info/`
- `examples/gridplanet/.notion_cache.json`
- `examples/gridplanet/.hugo_build.lock`
